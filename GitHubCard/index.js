...
axios.get('https://api.github.com/users/ongkasit')
    .then(userData => {
        let followingArray = [];
        axios.get('https://api.github.com/users/ongkasit/following')
            .then(followings => {
                followingArray = followings.data.map(followings => followings.login)

                followingArray.forEach(followingLogin => {
                    axios.get(`https://api.github.com/users/${followingLogin}`)
                        .then(followingData => {
                            cardsSection.appendChild(createCard(followingData.data))
                        })
...
// const followers = document.querySelector('.card')
